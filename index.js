...
// ANSWER: O(n) results are proportional to input
...
// ANSWER: Each function is dependent on the size of the string. So, for a string with 500 characters, it will create 500 different values. Size complexity is dependent upon the size of the input string.
